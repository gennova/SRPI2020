 ...
 * @author laravel
 */
public class PendidikanFormalUI_1 extends javax.swing.JFrame {
    ...
    private void initApp() {
        ...
        String tgl_keluar = TglLulus.getText();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(TglLulus, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (txtID.getText().equalsIgnoreCase("")) {
            ...
            String tglMasuk = sdf.format(TglMasuk.getText());
            String tglLulus = sdf.format(TglLulus.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PendidikanFormalUI_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PendidikanFormalUI_1().setVisible(true);
            }
        });
    }
