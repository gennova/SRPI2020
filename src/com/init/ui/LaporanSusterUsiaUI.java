 ...
 * @author laravel
 */
public class LaporanSusterUsiaUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanSusterUsiaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanSusterUsiaUI().setVisible(true);
            }
        });
    }
